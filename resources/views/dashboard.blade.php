        ...
        <div class="grid grid-cols-12 gap-x-6">
                ...
                <div class="box top-countries-card">
                    <div class="box-header !border-b-0 !p-0">
                        <h4 class="box-title !mb-1">Your Top Countries</h4><span
                            class="d-block text-textmuted font-normal text-[0.75rem] !mb-2">Sales performance revenue based
                            by country</span>
                    </div>
            ...
            <div class="md:col-span-12 lg:col-span-8 xl:col-span-8 col-span-12">
                <div class="box !p-[20px]">
                    ...
                    <span class="text-[0.75rem] text-textmuted mb-3 ">This is your most recent earnings for today's
                        date.</span>
