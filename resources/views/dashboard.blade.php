                  ...
                  <div class="box-body !p-0 customers mt-1">
                      <div class="ti-list-group ti-list-group-flush">
                          <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                              <div class="flex">
                                  <img class="avatar avatar-md avatar-rounded my-auto me-4" src="{{ asset('backend/assets/images/faces/3.jpg') }}" alt="Image description">
                                  <div class="flex-grow">
                          ...
                          <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                              <div class="flex">
                                  <img class="avatar avatar-md avatar-rounded my-auto me-4" src="{{ asset('backend/assets/images/faces/11.jpg') }}" alt="Image description">
                                  <div class="flex-grow">
                                      <div class="flex items-center">
                                          <div class="mt-1">
                          ...
                          <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                              <div class="flex">
                                  <img class="avatar avatar-md avatar-rounded my-auto me-4" src="{{ asset('backend/assets/images/faces/17.jpg') }}" alt="Image description">
                                  <div class="flex-grow">
                                      <div class="flex items-center">
                                          <div class="mt-1">
                          ...
                          <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                              <div class="flex">
                                  <img class="avatar avatar-md avatar-rounded my-auto me-4" src="{{ asset('backend/assets/images/faces/15.jpg') }}" alt="Image description">
                                  <div class="flex-grow">
                                      <div class="flex items-center">
                                          <div class="mt-1">
                          ...
                          <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                              <div class="flex">
                                  <img class="avatar avatar-md avatar-rounded my-auto me-4" src="{{ asset('backend/assets/images/faces/6.jpg') }}" alt="Image description">
                                  <div class="flex-grow">
                                      <div class="flex items-center">
                                          <div class="mt-1">
